...
typedef enum kmp_sched {
  ...
  kmp_sched_pls=119, // mapped to kmp_sch_pls (64)
  //--------------LB4OMP_extensions----------------
  kmp_sched_upper,
...
typedef struct KMP_ALIGN_CACHE dispatch_private_info32 {
  ...
  struct KMP_ALIGN(32) {
    ...
    kmp_real32 flt_parm2;
    kmp_real32 flt_parm3;
    kmp_real32 flt_parm4;
    kmp_real32 flt_parm5;
    kmp_real32 flt_parm6;
    kmp_real32 flt_parm7;
    kmp_real32 flt_parm8;
...
typedef struct KMP_ALIGN_CACHE dispatch_private_info64 {
  ...
  struct KMP_ALIGN(64) {
    ...
    kmp_real64 dbl_parm2;
    kmp_real64 dbl_parm3;
    kmp_real64 dbl_parm4;
    kmp_real64 dbl_parm5;
    kmp_real64 dbl_parm6;
    kmp_real64 dbl_parm7;
    kmp_real64 dbl_parm8;
    /* For debug chunk prints only */
#if KMP_DEBUG
    std::vector<kmp_int64> chunks;
#endif
    /* For debug chunk prints only */
  };
  //-----------------LB4OMP_extensions---------------
...
typedef struct dispatch_shared_info32 {
  ...
  volatile kmp_uint32 chunk_size;
  /* Counter used in FAC */
  volatile kmp_uint32 counter;
  /* Queue counter used in FAC */
  volatile kmp_int32 q_counter;
  /* Batch index used in batched schedules */
  volatile kmp_uint32 batch;
  /*************BOLD***************/
  struct KMP_ALIGN(32) {
    volatile kmp_int32 bold_m;
    volatile kmp_int32 bold_n;
    volatile kmp_int32 total_speed;
...
typedef struct dispatch_shared_info64 {
  ...
  volatile bool initialized;
  /* Batch chunk size used in FAC schedules */
  volatile kmp_uint64 chunk_size;
  /* Counter used in FAC */
  volatile kmp_uint64 counter;
  /* Queue counter used in FAC */
  volatile kmp_int64 q_counter;
  /* Batch index used in batched schedules */
  volatile kmp_uint64 batch;
  /*************BOLD***************/
  struct KMP_ALIGN(64) {
    volatile kmp_int64 bold_m;
    volatile kmp_int64 bold_n;
    volatile kmp_int64 total_speed;
    volatile std::atomic<kmp_int64> bold_time;
  };
  /*************BOLD***************/
  /*************AWF/AF****************/
...
extern int __kmp_env_cpu_speed; /* cpu frequency [MHz] */
