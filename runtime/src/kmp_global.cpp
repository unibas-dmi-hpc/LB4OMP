...
enum sched_type __kmp_sch_map[kmp_sched_upper - kmp_sched_lower_ext +
    ...
    kmp_sch_faca, // ==> kmp_sch_faca          = 106
    kmp_sch_fac2, // ==> kmp_sch_fac2          = 107
    kmp_sch_fac2a, // ==> kmp_sch_fac2a          = 108
    kmp_sch_wf, // ==> kmp_sch_wf          = 109
    kmp_sch_bold, // ==> kmp_sch_bold          = 110
    kmp_sch_awf_b, // ==> kmp_sch_awf_b          = 111
    kmp_sch_awf_c, // ==> kmp_sch_awf_c          = 112
    kmp_sch_awf_d, // ==> kmp_sch_awf_d          = 113
    ...
    kmp_sch_mfsc, // ==> kmp_sch_mfsc   = 121
    kmp_sch_fiss, // ==> kmp_sch_mfsc   = 122
    //--------------LB4OMP_extensions----------------
...
int __kmp_env_cpu_speed = 2400; /* cpu frequency [MHz] */
